                    ...
                    .then(CommandManager.literal("camera")
                        .then(CommandManager.literal("movie")
                            ...
                            .then(CommandManager.literal("title")
                                .then(CommandManager.argument("x", FloatArgumentType.floatArg(-999f, 999f))
                                    .then(CommandManager.argument("y", FloatArgumentType.floatArg(-999f, 999f))
                                        .executes(ctx -> fb(ctx, "§aTitle 偏移指令已发送"))
                                        .then(CommandManager.argument("duration", FloatArgumentType.floatArg(0f))
                                            .executes(ctx -> fb(ctx, "§aTitle 偏移指令已发送"))
                                        )
                                    )
                                )
                            ...
                            .then(CommandManager.literal("subtitle")
                                .then(CommandManager.argument("x", FloatArgumentType.floatArg(-999f, 999f))
                                    .then(CommandManager.argument("y", FloatArgumentType.floatArg(-999f, 999f))
                                        .executes(ctx -> fb(ctx, "§aSubtitle 偏移指令已发送"))
                                        .then(CommandManager.argument("duration", FloatArgumentType.floatArg(0f))
                                            .executes(ctx -> fb(ctx, "§aSubtitle 偏移指令已发送"))
                                        )
                                    )
                            ...
                            .then(CommandManager.literal("actionbar")
                                .then(CommandManager.argument("x", FloatArgumentType.floatArg(-999f, 999f))
                                    .then(CommandManager.argument("y", FloatArgumentType.floatArg(-999f, 999f))
                                        .executes(ctx -> fb(ctx, "§aActionbar 偏移指令已发送"))
                                        .then(CommandManager.argument("duration", FloatArgumentType.floatArg(0f))
                                            .executes(ctx -> fb(ctx, "§aActionbar 偏移指令已发送"))
                                        )
                                    )
                        ...
                        .then(CommandManager.literal("overshoulder")
                            .then(CommandManager.literal("enable")
                                ...
                                .then(CommandManager.argument("distance", FloatArgumentType.floatArg(-99f, 99f))
                                    .executes(ctx -> fb(ctx, "§a越肩视角指令已发送"))
                                    .then(CommandManager.argument("offset", FloatArgumentType.floatArg(-99f, 99f))
                                        .executes(ctx -> fb(ctx, "§a越肩视角指令已发送"))
                                        .then(CommandManager.argument("height", FloatArgumentType.floatArg(-99f, 99f))
                                            .executes(ctx -> fb(ctx, "§a越肩视角指令已发送"))
                                        )
                                    )
                                )
